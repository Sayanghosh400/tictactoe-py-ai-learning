...
def winner(board):
    ...
    """
    if checkcol(board, X) or checkrow(board, X) or firstdig(board, X) or seconddig(board, X):
        return X
    elif checkcol(board, O) or checkrow(board, O) or firstdig(board, O) or seconddig(board, O):
        return O
    else:
        None
